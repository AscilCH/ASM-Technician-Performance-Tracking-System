...
export class ReclamationsComponent implements OnInit {
        ...
        this.recService.getRecs()
            .pipe(
                catchError(error => {
                    ...
                    this.messageService.add({ severity: 'error', summary: 'Error', detail: 'Error fetching reclamations', life: 3000 });
    ...
    loadTechnicians() {
      ...
      gettechname(technicien_id: number): string {
        
        const technician = this.technicians.find(t => t.id === technicien_id);
